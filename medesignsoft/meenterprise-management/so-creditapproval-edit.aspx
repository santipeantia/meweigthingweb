<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="so-creditapproval-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.so_creditapproval_edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                if (mod == 'new') {
                    ...
                    (async () => {
                       await getSOCreditApprovalByid(gid);
                    })();
                ...
                async function getSOCreditApprovalByid(gid) {
                    try {
                        await getEmployeeUser();
                       
                        $.ajax({
                            url: 'general-services.asmx/getSOCreditApproveById',
                            method: 'post',
                            data: {
                                gid: gid,
                            },
                            ...
                            success: function (data) {
                                ...
                                if (obj != '') {
                                    $.each(obj, function (i, data) {
                                        $('#hiddengid').val(data["SoAppCreditID"]);
                ...
                btnundo.click(function () {
                    window.location.href = "so-creditapproval-setup.aspx?opt=optso";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getSoCreditApprovalUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        SoAppCreditID: $('#hiddengid').val(),
        ...
        <h1>SO Credit Approval Edit <%--step 1 check pages content name--%>
                ...
                <div class="">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            ...
                            <label class="txtLabel">Credit Approval Edit</label>
                        </div>
