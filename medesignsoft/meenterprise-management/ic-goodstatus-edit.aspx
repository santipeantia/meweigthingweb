<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ic-goodstatus-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.ic_goodstatus_edit" %>
     ...
     <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function getGoodStatusbyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getGoodStatusById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    $('#hiddengid').val(data["GoodStatID"]);
                                    $('#txtGoodStatCode').val(data["GoodStatCode"]);
                                    $('#txtGoodStatDesc').val(data["GoodStatDesc"]);
                ...
                btnundo.click(function () {
                    window.location.href = "ic-goodstatus-setup.aspx?opt=optic";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getGoodStatusUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        GoodStatID: $('#hiddengid').val(),
                                        GoodStatCode: $('#txtGoodStatCode').val(),
                                        GoodStatDesc: $('#txtGoodStatDesc').val(),
        ...
        <h1>Good Status Edit <%--step 1 check pages content name--%>
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtGoodStatCode" class="form-control ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtGoodStatDesc" class="form-control ">
                                    </div>
                                </div>
