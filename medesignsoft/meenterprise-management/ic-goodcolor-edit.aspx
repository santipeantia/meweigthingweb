    ...
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function getGoodColorbyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getGoodColorById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    $('#hiddengid').val(data["GoodColorID"]);
                                    $('#txtGoodColorCode').val(data["GoodColorCode"]);
                                    $('#txtGoodColorDesc').val(data["GoodColorDesc"]);
                ...
                btnundo.click(function () {
                    window.location.href = "ic-goodcolor-setup.aspx?opt=optic";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getGoodColorUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        GoodColorID: $('#hiddengid').val(),
                                        GoodColorCode: $('#txtGoodColorCode').val(),
                                        GoodColorDesc: $('#txtGoodColorDesc').val(),
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtGoodColorCode" class="form-control ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtGoodColorDesc" class="form-control ">
                                    </div>
                                </div>
