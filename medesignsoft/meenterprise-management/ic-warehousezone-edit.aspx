<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ic-warehousezone-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.ic_warehousezone_edit" %>
            ...
            $(document).ready(function () {
                ...
                function getWarehouse() {
                    $.ajax({
                        ...
                        success: function (data) {
                            selectwhid.empty();
                            selectwhid.append($('<option/>', { value: -1, text: 'Please choose warehouse..' }));
                            $(data).each(function (index, item) {
                                selectwhid.append($('<option/>', { value: item.WhID, text: item.WhDesc }));
                            });
                        }
                    });
                }

                function getWerehousezonebyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getWarehouseZoneById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    $('#hiddengid').val(data["WhZoneID"]);
                                    $('#selectwhid').val(data["WhID"]);
                                    $('#selectwhid').change();
                                    $('#txtWhZoneCode').val(data["WhZoneCode"]);
                                    $('#txtWhZoneDesc').val(data["WhZoneDesc"]);
                ...
                btnundo.click(function () {
                    window.location.href = "ic-warehouse-setup.aspx?opt=optic";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getWarehouseZoneUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        WhZoneID: $('#hiddengid').val(),
                                        WhID: $('#selectwhid').val(),
                                        WhZoneCode: $('#txtWhZoneCode').val(),
                                        WhZoneDesc: $('#txtWhZoneDesc').val(),
                                    ...
                                    success: function (data) {
                                        ...
                                        setTimeout(function () {
                                            window.location.href = "ic-warehousezone-setup.aspx?opt=optic";
                                        }, 2000);
                                    },
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label txtLabel text-right">คลังสินค้า <span id="errwhid" class="text-red txtLabel hidden">***</span></label>
                                    <div class="col-sm-8">
                                       <span class="txtLabel " style="width: 100%">
                                            <select id="selectwhid" class="form-control input-sm " style="width: 100%" >
                                            </select>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtWhZoneCode" class="form-control ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtWhZoneDesc" class="form-control ">
                                    </div>
                                </div>
