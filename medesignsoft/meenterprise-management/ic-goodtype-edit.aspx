<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ic-goodtype-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.ic_goodtype_edit" %>
    ...
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                var selectgoodgroup = $('#selectgoodgroup');
                function getGoodGroup() {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            selectgoodgroup.append($('<option/>', { value: -1, text: 'Please choose group..' }));
                            $(data).each(function (index, item) {
                ...
                function getGoodTypebyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getGoodTypeById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    $('#hiddengid').val(data["GoodTypeID"]);
                                    $('#selectgoodgroup').val(data["GoodGroupID"]);
                                    $('#selectgoodgroup').change();
                                    $('#txtGoodTypeCode').val(data["GoodTypeCode"]);
                                    $('#txtGoodTypeDesc').val(data["GoodTypeDesc"]);
                ...
                btnundo.click(function () {
                    window.location.href = "ic-goodtype-setup.aspx?opt=optic";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getGoodTypeUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        GoodTypeID: $('#hiddengid').val(),
                                        GoodGroupID: $('#selectgoodgroup').val(),
                                        GoodTypeCode: $('#txtGoodTypeCode').val(),
                                        GoodTypeDesc: $('#txtGoodTypeDesc').val(),
        ...
        <h1>Good Type Edit <%--step 1 check pages content name--%>
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <span class="txtLabel " style="width: 100%">
                                            <select id="selectgoodgroup" class="form-control input-sm " style="width: 100%" >
                                            </select>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtGoodTypeCode" class="form-control ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtGoodTypeDesc" class="form-control ">
                                    </div>
                                </div>
