                ...
                <div class="">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            ...
                            <label class="txtLabel">จัดการข้อมูลเจ้าหนี้</label>
                        </div>
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table id="tblapllist" class="table table-striped table-bordered table-hover table-condensed" style="width: 100%">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">กำหนดรหัสเจ้าหนี้</td>
                                                <td class=" table-align-center">
                                                    <a class="btn btn-primary outline btn-block" href="ap-vendor-setup.aspx?opt=optap">                                                   
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">กำหนดประเภทเจ้าหนี้</td>
                                                <td class=" table-align-center">
                                                    <a class="btn btn-primary outline btn-block" href="ap-category-setup.aspx?opt=optap">                                                   
                                                    <i class="fa fa-eyedropper"></i>
                                                </a></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">กำหนดกลุ่มประเภทเจ้าหนี้</td>
                                                <td class=" table-align-center">
                                                    <a class="btn btn-primary outline btn-block" href="ap-group-setup.aspx?opt=optap">                                                   
                                                    <i class="fa fa-eyedropper"></i>
                                                </a></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">กำหนดสถานที่รับสินค้า</td>
                                                <td class=" table-align-center">
                                                    <a class="btn btn-primary outline btn-block" href="ap-ship-setup.aspx?opt=optap">                                                   
                                                    <i class="fa fa-eyedropper"></i>
                                                </a></td>
