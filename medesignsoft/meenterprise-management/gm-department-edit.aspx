<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="gm-department-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.gm_department_edit" %>
     ...
     <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function getdepartmentbyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getDepartmentById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    ...
                                    $('#txtdepartmentcode').val(data["imDepartmentID"]);
                                    $('#txtdepartmentname').val(data["DepartmentDesc"]);
                                    $('#txtdepartmentname2').val(data["DepartmentDesc2"]);
                ...
                btnundo.click(function () {
                    window.location.href = "gm-department-setup.aspx?opt=optgen";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                  ...
                                  $.ajax({
                                    url: 'general-services.asmx/getDepartmentUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        Gid: $('#hiddengid').val(),
                                        imDepartmentID: $('#txtdepartmentcode').val(),
                                        DepartmentDesc: $('#txtdepartmentname').val(),
                                        DepartmentDesc2: $('#txtdepartmentname2').val(),
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtdepartmentcode" class="form-control ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtdepartmentname2" class="form-control ">
                                    </div>
                                </div>  
