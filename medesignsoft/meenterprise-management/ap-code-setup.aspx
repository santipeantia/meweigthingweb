<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ap-code-setup.aspx.cs" Inherits="medesignsoft.meenterprise_management.ap_code_setup" %>
    ...
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function reloaddata() {
                    $.ajax({
                        url: 'general-services.asmx/getVendorsList',
                        method: 'post',
                        //data: {
                        //    yearstart: yearstart,
                        //    yearend: yearend,
                        ...
                        success: function (data) {
                            ...
                            $('#tblvendorlist td:nth-of-type(6)').addClass('column_hover');
                            $('#tblvendorlist td:nth-of-type(8)').addClass('column_hover');
                            ...
                            $('#tblvendorlist td').click(function () {
                                ...
                                if (rIndex != 0 & cIndex == 7) {
                                    ...
                                    window.location.href = "ap-vendor-edit.aspx?opt=optgen&mod=edit&gid=" + gid.text();
                                }

                                if (rIndex != 0 & cIndex == 8) {
                                    var gid = $("#tblvendorlist").find('tr:eq(' + rIndex + ')').find('td:eq(0)');
                                    console.log(gid.text());
                                    window.location.href = "ap-vendor-edit.aspx?opt=optgen&mod=del&gid=" + gid.text();
                                }
