...
namespace medesignsoft
{
    public class cGoodCodeList
    {
        ...
        public string GoodColorDesc { get; set; }
        ...
        public string GoodLength { get; set; }
        public string GoodHeight { get; set; }
        public string GoodStatID { get; set; }
        public string GoodStatDesc { get; set; }
