<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ic-warehouse-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.ic_warehouse_edit" %>
    ...
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function getWerehousebyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getWarehouseById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    $('#hiddengid').val(data["WhID"]);
                                    $('#txtWhCode').val(data["WhCode"]);
                                    $('#txtWhDesc').val(data["WhDesc"]);
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getWarehouseUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        WhID: $('#hiddengid').val(),
                                        WhCode: $('#txtWhCode').val(),
                                        WhDesc: $('#txtWhDesc').val(),
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtWhCode" class="form-control ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtWhDesc" class="form-control ">
                                    </div>
                                </div>
