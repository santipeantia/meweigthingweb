...
{
    public partial class ic_goodcode_setup : System.Web.UI.Page
    {
        ...
        protected void btnExportExcel_click(object sender, EventArgs e)
        {
            try
            {
                ...
                Comm = new SqlCommand("spGetGoodCodeExcelList", Conn);
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    Response.Clear();
                    Response.AddHeader("content-disposition", "attachment;filename=ExportGoodCode.xls");
