        ...
        <script>
            $(document).ready(function () {
                ...
                btnundo.click(function () {
                    window.location.href = "so-approval-setup.aspx?opt=optso";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getSOApprovalUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        SoApproveID: $('#hiddengid').val(),
                                        imEmployeeGidU: $('#selectemployeeuser').val(),
                                        imEmployeeGidH: $('#selectemployeehead').val(),
