<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ar-vendor-setup.aspx.cs" Inherits="medesignsoft.meenterprise_management.ar_vendor_setup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <script>
            $(document).ready(function () {
                ...
                function reloaddata() {
                    $.ajax({
                        url: 'general-services.asmx/getVendorArList',
                        method: 'post',
                        //data: {
                        //    yearstart: yearstart,
                        //    yearend: yearend,
                ...
                <div class="">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            ...
                            <label class="txtLabel">Customer List</label>
                        </div>
