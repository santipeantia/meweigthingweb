<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="gm-section-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.gm_section_edit" %>
    ...
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function getsectionbyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getSectionById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    ...
                                    $('#txtsectioncode').val(data["imSectionID"]);
                                    $('#txtsectionname').val(data["SectionDesc"]);
                                    $('#txtsectionname2').val(data["SectionDesc2"]);
                ...
                btnundo.click(function () {
                    window.location.href = "gm-section-setup.aspx?opt=optgen";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                  ...
                                  $.ajax({
                                    url: 'general-services.asmx/getSectionUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        Gid: $('#hiddengid').val(),
                                        imSectionID: $('#txtsectioncode').val(),
                                        SectionDesc: $('#txtsectionname').val(),
                                        SectionDesc2: $('#txtsectionname2').val(),
