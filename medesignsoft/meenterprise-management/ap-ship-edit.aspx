<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ap-ship-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.ap_ship_edit" %>
     ...
     <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function getShipmentbyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getShipmentById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    $('#hiddengid').val(data["ShipmentID"]);
                                    $('#txtShipmentCode').val(data["ShipmentCode"]);
                                    $('#txtShipmentName').val(data["ShipmentName"]);
                                    $('#txtShipmentNameEng').val(data["ShipmentNameEng"]);
                ...
                btnundo.click(function () {
                    window.location.href = "ap-ship-setup.aspx?opt=optap";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getShipmentUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        ShipmentID: $('#hiddengid').val(),
                                        ShipmentCode: $('#txtShipmentCode').val(),
                                        ShipmentName: $('#txtShipmentName').val(),
                                        ShipmentNameEng: $('#txtShipmentNameEng').val(),
        ...
        <h1>Vendor Group Edit <%--step 1 check pages content name--%>
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtShipmentCode" class="form-control ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtShipmentName" class="form-control ">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtShipmentNameEng" class="form-control ">
                                    </div>
                                </div>
