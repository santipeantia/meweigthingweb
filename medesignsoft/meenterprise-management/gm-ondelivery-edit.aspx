                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label txtLabel text-right">ชื่อประเภทขนส่ง (TH) <span id="errpaymentth" class="text-red txtLabel hidden">***</span></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label txtLabel text-right">ชื่อประเภทขนส่ง (EN)<span id="errpaymenten" class="text-red txtLabel hidden">***</span></label>
                                    <div class="col-sm-8">
