<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ic-goodunit-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.ic_goodunit_edit" %>
    ...
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function getGoodUnitbyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getGoodUnitById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    $('#hiddengid').val(data["GoodUnitID"]);
                                    $('#txtGoodUnitCode').val(data["GoodUnitCode"]);
                                    $('#txtGoodUnitDesc').val(data["GoodUnitDesc"]);
                ...
                btnundo.click(function () {
                    window.location.href = "ic-goodunit-setup.aspx?opt=optic";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getGoodUnitUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        GoodUnitID: $('#hiddengid').val(),
                                        GoodUnitCode: $('#txtGoodUnitCode').val(),
                                        GoodUnitDesc: $('#txtGoodUnitDesc').val(),
        ...
        <h1>Good Unit Edit <%--step 1 check pages content name--%>
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtGoodUnitCode" class="form-control ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="txtGoodUnitDesc" class="form-control ">
                                    </div>
                                </div>
