<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="so-approvelevel-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.so_approvelevel_edit" %>
    ...
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                //        },
                //        success: function (data) {
                //            selectemployeehead.empty();
                //            selectemployeehead.append($('<option/>', { value: -1, text: 'Please select head sales..'}));
                //            $(data).each(function (index, item) {
                ...
                async function getSOApproveLevelbyid(gid) {
                    try {
                        await getEmployeeUser();
                        await getSOLevel();

                        $.ajax({
                            url: 'general-services.asmx/getSOApprovalLevelById',
                            method: 'post',
                            data: {
                                gid: gid,
                            },
                            ...
                            success: function (data) {
                                ...
                                if (obj != '') {
                                    $.each(obj, function (i, data) {
                                        $('#hiddengid').val(data["SoAppLevelID"]);
                                        $('#selectemployeeuser').val(data["imEmployeeGid"]);
                                        $('#selectemployeeuser').change();
                                        $('#selectsoapprovelevel').val(data["SoLevelID"]);
                                        $('#selectsoapprovelevel').change();
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label txtLabel text-right">ลำดับการอนุมัติ <span id="erremployeehead" class="text-red txtLabel hidden">***</span></label>
                                    <div class="col-sm-8">
                                        <span class="txtLabel " style="width: 100%">
                                            <select id="selectsoapprovelevel" class="form-control input-sm " style="width: 100%">
                                            </select>
                                        </span>
                                    </div>
