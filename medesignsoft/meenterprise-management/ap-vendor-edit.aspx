<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ap-vendor-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.ap_vendor_edit" %>
        ...
        <script>
            $(document).ready(function () {
                ...
                btnundo.click(function () {
                    window.location.href = "ap-vendor-setup.aspx?opt=optap";
                ...
                <div class="">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            ...
                            <label class="txtLabel">Vendor Edit</label>
                        </div>
