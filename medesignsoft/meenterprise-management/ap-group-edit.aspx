<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="ap-group-edit.aspx.cs" Inherits="medesignsoft.meenterprise_management.ap_group_edit" %>
    ...
    <section class="content-header">
        ...
        <script>
            $(document).ready(function () {
                ...
                function getVendorGroupbyid(gid) {
                    $.ajax({
                        url: 'general-services.asmx/getVendorGroupById',
                        method: 'post',
                        data: {
                            gid: gid,
                        },
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                $.each(obj, function (i, data) {
                                    $('#hiddengid').val(data["VendorGroupID"]);
                                    $('#txtVendorGroupCode').val(data["VendorGroupCode"]);
                                    $('#txtVendorGroupName').val(data["VendorGroupName"]);
                                    $('#txtVendorGroupNameEng').val(data["VendorGroupNameEng"]);
                ...
                btnundo.click(function () {
                    window.location.href = "ap-group-setup.aspx?opt=optap";
                    ...
                    if (chkvalidate == 'true') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'general-services.asmx/getVendorGroupUpdateEntry',
                                    method: 'post',
                                    data: {
                                        acttrans: 'new',
                                        gid: $('#hiddengid').val(),
                                        VendorGroupID: $('#hiddengid').val(),
                                        VendorGroupCode: $('#txtVendorGroupCode').val(),
                                        VendorGroupName: $('#txtVendorGroupName').val(),
                                        VendorGroupNameEng: $('#txtVendorGroupNameEng').val(),
