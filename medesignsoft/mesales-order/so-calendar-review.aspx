<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="so-calendar-review.aspx.cs" Inherits="medesignsoft.mesales_order.so_calendar_review" %>
                ...
                <div class="">
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="so-calendar.aspx?opt=optsoc" style="width: 100%">
                                        <span class="badge bg-yellow">1</span>
                                        <i class="fa fa-file-powerpoint-o"></i><span class="txtLabel">อนุมัติใบเสนอราคาสินค้า </span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="so-order-approve.aspx?opt=optsoc" style="width: 100%">
                                        <span class="badge bg-yellow">2</span>
                                        <i class="fa fa-calculator"></i><span class="txtLabel">อนุมัติใบสั่งขายสินค้า</span>
                                    </a>
                                </div>
