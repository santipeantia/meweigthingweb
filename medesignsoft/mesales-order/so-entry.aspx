<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="so-entry.aspx.cs" Inherits="medesignsoft.mesales_order.so_entry" %>
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="so-order-view.aspx?opt=optsoe" style="width: 100%">
                                        <span class="badge bg-yellow">2</span>
                                        <i class="fa fa-calculator"></i><span class="txtLabel">ใบสั่งขายสินค้า</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="so-deposit-view.aspx?opt=optsoe" style="width: 100%">
                                        <span class="badge bg-yellow">3</span>
                                        <i class="fa fa-credit-card"></i><span class="txtLabel">รับเงินมัดจำ</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class=" btn btn-app" href="so-creditsale-view.aspx?opt=optsoe" style="width: 100%">
                                        <span class="badge bg-yellow">4</span>
                                        <i class="fa fa-address-card-o"></i><span class="txtLabel">ขายสินค้าเชื่อ</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="so-cashsale-view.aspx?opt=optsoe" style="width: 100%">
                                        <span class="badge bg-yellow">5</span>
                                        <i class="fa fa-money"></i><span class="txtLabel">ขายสินค้าเงินสด</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="so-creditnote-view.aspx?opt=optsoe" style="width: 100%">
                                        <span class="badge bg-yellow">6</span>
                                        <i class="fa fa-handshake-o"></i><span class="txtLabel">รับคืน ลดหนี้</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="so-debitnote-view.aspx?opt=optsoe" style="width: 100%">
                                        <span class="badge bg-yellow">7</span>
                                        <i class="fa fa-hand-o-up"></i><span class="txtLabel">เพิ่มหนี้ลูกหนี้</span>
                                    </a>
                                </div>
