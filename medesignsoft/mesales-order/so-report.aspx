<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="so-report.aspx.cs" Inherits="medesignsoft.mesales_order.so_report" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <section class="content-header">
        ...
        <h1>SO Report <%--step 1 check pages content name--%>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-company-setup.aspx?opt=optgen" style="width: 100%">
                                        ...
                                        <i class="fa fa-file-powerpoint-o"></i><span class="txtLabel">รายงานการเสนอสินค้าประจำวัน</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-branch-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">2</span>
                                        <i class="fa fa-calculator"></i><span class="txtLabel">รายงานการขายสินค้าประจำวัน</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-section-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">3</span>
                                        <i class="fa fa-credit-card"></i><span class="txtLabel">รายงานการขายตามรหัสลูกค้า</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class=" btn btn-app" href="gm-department-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">4</span>
                                        <i class="fa fa-address-card-o"></i><span class="txtLabel">รายงานการขายตามรหัสสินค้าคงคลัง</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-employees-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">5</span>
                                        <i class="fa fa-money"></i><span class="txtLabel">รายงานการขายตามประเภทการขายสด</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-document-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">6</span>
                                        <i class="fa fa-handshake-o"></i><span class="txtLabel">รายงานการขายตามประเภทการขายเชื่อ</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-terms-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">7</span>
                                        <i class="fa fa-hand-o-up"></i><span class="txtLabel">รายงานการขายตามรหัสพนักงานขาย</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-terms-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">8</span>
                                        <i class="fa fa-hand-o-up"></i><span class="txtLabel">รายงานภาษีขายประจำวัน</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-terms-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">9</span>
                                        <i class="fa fa-hand-o-up"></i><span class="txtLabel">รายงานสรุปการรับเงินประจำวัน</span>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-app" href="gm-terms-setup.aspx?opt=optgen" style="width: 100%">
                                        <span class="badge bg-yellow">10</span>
                                        <i class="fa fa-hand-o-up"></i><span class="txtLabel">รายงานรายละเอียดการขายประจำวัน</span>
                                    </a>
                                </div>
