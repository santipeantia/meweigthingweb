<%@ Page Title="" Language="C#" MasterPageFile="~/medesignsoft.Master" AutoEventWireup="true" CodeBehind="so-calendar.aspx.cs" Inherits="medesignsoft.mesales_order.so_calendar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <script>
            $(document).ready(function () {
                ...
                function reloaddata() {
                    ...
                    $.ajax({
                        url: 'saleorder-services.asmx/getQuotationApprovalList',
                        method: 'post',
                        data: {
                            empid: empid                        
                        },
                        ...
                        success: function (data) {
                            ...
                            $('#tblsoquotationlist tbody').on('click', 'td', function (e) {
                                ...
                                if (rIndex != 0 & cIndex == 49) {
                                    window.location.href = "so-quotation-review.aspx?opt=optsoc&mod=edit&gid=" + gid.text();
                                }

                                if (rIndex != 0 & cIndex == 50) {
                                    window.location.href = "so-quotation-review.aspx?opt=optsoc&mod=del&gid=" + gid.text();
                                }
                            });
        ...
        <h1>Quotation Pending Approval <%--step 1 check pages content name--%>
